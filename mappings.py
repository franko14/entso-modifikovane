BORDER_FLOWS = {
    ...
    'BA': ['HR', 'ME', 'RS'],
    'SK': ['CZ', 'HU', 'PL', 'UA'],
    'DE-LU': ['AT', 'CZ', 'FR', 'PL', 'SE-4'],
    'UA': ['SK','RO','HU','PL']
}

MAXIMUM_FLOW_CAPACITY = {
    'CZ->DE-LU' : 2800,
    'DE-LU->CZ' : 2800,
    'PL->CZ'    : 570,
    'CZ->PL'    : 850,
...
ETS_COUNTRIES = ['AT','BE','HR','CY','CZ','DK','EE','FI','FR','DE','GR','HU',
                 'IE','LV','LT','NL','PT','SK','SI','IT','ES','GB','BG','PL',
                 'RO']
